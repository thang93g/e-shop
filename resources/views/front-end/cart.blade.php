                    ...
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Subtotal<span>$&nbsp <span
                                                    id="cart_subtotal">{{$totalPrice[0]->price}}</span></span></li>
                                        <li>Shipping<span>Free</span></li>
                                        <li>You Save<span>$ 0.00</span></li>
                                        <li class="last">You Pay<span>$&nbsp <span
                                                    id="you-pay">{{$totalPrice[0]->price}}</span></span>
                                        </li>
                                    </ul>
                                    <div class="button5">
